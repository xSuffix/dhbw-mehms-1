  ...
  <body>
    ...
    <main class="container">
      <section>
        ...
        <p>Du hast selbsterstellte Mehms, Vines oder Zitate, die du gerne mit anderen teilen möchtest? Diese Website lebt von euren Einsendungen!
          <br> Außerdem wird jede Einsendung auf Einmaligkeit überprüft, daher kann es sein, dass es einige Tage dauert, bis dein Mehm auf dieser Website sichtbar wird. Wir bitten um Verständnis. 
        </p>
        <form action="memeFormular.php" method="post" enctype="multipart/form-data">
          <label for="datei">Datei
          </label>
          <input type="file"  name="mDatei" id="datei"> 
          <!--(required)-->
          <br>
          ...
          <select name="mKategorie" id="kategorie" required>
            ...
            <option value="Programmieren">Programmieren
            </option>
            <option value="DHBW">DHBW
            </option>
            <option value="Aandere">Andere
            </option>
          </select>
          <br>
          <label for="autor">Autor
          </label>
          <input id="autor" type="text" placeholder="Autor des Mehms" name="mAutor">
          <br>
          <label for="kommentar">Kommentar
          </label>
          <textarea id="kommentar" placeholder="Kommentar" name="mKommentar">
          </textarea>
          <button> Absenden 
          </button>
        </form>
        <p> Bitte sende nur selbsterstellte Mehms ein. Keiner mag geklaute Mehms! 
          <br>Außerdem erheben wir keinerlei Anspruch auf die hier veröffentlichten Bilder.
        </p>
        <details>
          <summary> Mehr zum Thema Urheberrecht 
            </Summary>
          <p>Das Urheberrecht schützt den Urheber in seinen geistigen und persönlichen Beziehungen zum Werk und in der Nutzung des Werkes. Es dient zugleich der Sicherung einer angemessenen Vergütung für die Nutzung des Werkes.
          </p>
          <article> 
            <h2 class="document">Urheberpersönlichkeitsrecht
            </h2>
            <h3 class="document">§ 12 Veröffentlichungsrecht
            </h3>
            (1) Der Urheber hat das Recht zu bestimmen, ob und wie sein Werk zu veröffentlichen ist.
            (2) Dem Urheber ist es vorbehalten, den Inhalt seines Werkes öffentlich mitzuteilen oder zu beschreiben, solange weder das Werk noch der wesentliche Inhalt oder eine Beschreibung des Werkes mit seiner Zustimmung veröffentlicht ist.
            <h3 class="document">§ 13 Anerkennung der Urheberschaft
            </h3>
            Der Urheber hat das Recht auf Anerkennung seiner Urheberschaft am Werk. Er kann bestimmen, ob das Werk mit einer Urheberbezeichnung zu versehen und welche Bezeichnung zu verwenden ist.
            <h3 class="document">§ 14 Entstellung des Werkes
            </h3>
            Der Urheber hat das Recht, eine Entstellung oder eine andere Beeinträchtigung seines Werkes zu verbieten, die geeignet ist, seine berechtigten geistigen oder persönlichen Interessen am Werk zu gefährden.
            <h2 class="document">Verwertungsrechte
            </h2>
            (1) Der Urheber hat das ausschließliche Recht, sein Werk in körperlicher Form zu verwerten; das Recht umfaßt insbesondere
            <h3 class="document">§ 16 Vervielfältigungsrecht
            </h3>
            (1) Das Vervielfältigungsrecht ist das Recht, Vervielfältigungsstücke des Werkes herzustellen, gleichviel ob vorübergehend oder dauerhaft, in welchem Verfahren und in welcher Zahl.
            (2) Eine Vervielfältigung ist auch die Übertragung des Werkes auf Vorrichtungen zur wiederholbaren Wiedergabe von Bild- oder Tonfolgen (Bild- oder Tonträger), gleichviel, ob es sich um die Aufnahme einer Wiedergabe des Werkes auf einen Bild- oder Tonträger oder um die Übertragung des Werkes von einem Bild- oder Tonträger auf einen anderen handelt.
            <h3 class="document">§ 17 Verbreitungsrecht
            </h3>
            ...
            <h3 class="document">§ 18 Ausstellungsrecht
            </h3>
            ...
            <h3 class="document">§ 19 Vortrags-, Aufführungs- und Vorführungsrecht
            </h3>
            ...
            <h3 class="document">§ 19a Recht der öffentlichen Zugänglichmachung
            </h3>
            Das Recht der öffentlichen Zugänglichmachung ist das Recht, das Werk drahtgebunden oder drahtlos der Öffentlichkeit in einer Weise zugänglich zu machen, dass es Mitgliedern der Öffentlichkeit von Orten und zu Zeiten ihrer Wahl zugänglich ist.
            <h3 class="document">§ 20 Senderecht
            </h3>
            Das Senderecht ist das Recht, das Werk durch Funk, wie Ton- und Fernsehrundfunk, Satellitenrundfunk, Kabelfunk oder ähnliche technische Mittel, der Öffentlichkeit zugänglich zu machen.
            <h4 class="document">§ 20a Europäische Satellitensendung
            </h4>
            ...
            <h4 class="document">§ 20b Weitersendung
            </h4>
            ...
            <h4 class="document">§ 20c Europäischer ergänzender Online-Dienst
            </h4>
            ...
            <h4 class="document">§ 20d Direkteinspeisung
            </h4>
            ...
            <h3 class="document">§ 21 Recht der Wiedergabe durch Bild- oder Tonträger
            </h3>
            ...
            <h3 class="document">§ 23 Bearbeitungen und Umgestaltungen
            </h3>
            ...
            <h3 class="document">§ 25 Zugang zu Werkstücken
            </h3>
            ...
            <h3 class="document">§ 26 Folgerecht
            </h3>
            ...
            <h3 class="document">§ 27 Vergütung für Vermietung und Verleihen
            </h3>
        ...
        <p>Siehe auch: 
          <a class="underline" href="https://www.gesetze-im-internet.de/urhg/BJNR012730965.html#BJNR012730965BJNG000801377" target="_blank">Gesetz über Urheberrecht und verwandte Schutzrechte (Urheberrechtsgesetz)
          </a> 
        </p>
      </section>
    </main>
