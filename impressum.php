...
<body>
  ...
  <main class="container">
    <article>
	<div><h1 class='document'>Impressum</h1><h3 class='document'>Angaben gemäß § 5 TMG</h3>
	<p class='document'>DHBW Mosbach <br> 
	Lohrtalweg 10 <br> 
	74821 Mosbach 
	</p>
	...
	<h2 class='document'> Datenschutz </h2>
	<p class='document'>Beachten Sie bitte die verbindliche 
	<a class='document'  href="datenschutz.php">Datenschutzrichtlinie</a> der DHBW Mehms.</p>
